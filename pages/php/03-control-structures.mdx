...
A list of available operators can be found [in the PHP manual](https://www.php.net/manual/en/language.operators.comparison.php).
...
Conditions can be strung together with Logical Operators. The list of available Logical Operators are also viewable [in the PHP manual](https://www.php.net/manual/en/language.operators.comparison.php).
...
To get an extensive overview of all different data types and how they evaluate to booleans, you can reference the [PHP manual](https://www.php.net/manual/en/types.comparisons.php)
...
If you want to get a head-start, you can read more about other control structures in [the PHP manual](https://www.php.net/manual/en/language.control-structures.php).
...
<ChapterNavigator prev="/php/02-first-php-script" next="/php/04-php-in-html" />
