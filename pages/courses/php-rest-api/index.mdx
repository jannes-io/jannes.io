...
Our goal is to build this API together, and explain the thought process behind each step. If you're just going to copy every
code snippet, you will have a functioning API, but you will not have learnt anything.
So try to really understand each step or research more about the topic when you lose sight.
...
This course assumes you have at least an intermediate understanding of PHP and its syntax.
